...
def setup_behavior_tree():
    ...
    aggro_spread_sequence = Sequence(name='Aggr. Spread Strategy')
    fewest_planets_check = Check(have_fewest_planets)
    produce = Action(produce_attack)
    spread_all = Action(spread_all_neutral)
    aggro_spread_sequence.child_nodes = [fewest_planets_check, produce, spread_all]
